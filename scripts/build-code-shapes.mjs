 ...
 * how many examples agreed, and one example code. No project names, refs or descriptions.
...
import { buildShapes, makerKey } from '../src/utils/codeShapes.js'
...
const shapes = [...merged.values()].sort((a, b) =>
...
fs.writeFileSync(out, JSON.stringify({
  version: 1,
  note: 'Generated by scripts/build-code-shapes.mjs. Shapes only: maker, code shape, canon family, ref head, agreement, one example code.',
