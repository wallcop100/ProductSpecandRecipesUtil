...
/**
 * Sockets, plugs and strain reliefs are the Connectors screen's job (ConnectorsScreen →
 * CoverageMatrix), as Connector Templates. The built-in templates used to prime the same rows,
 * so every applied template shipped a half-built connector set to reconcile. They now carry
 * only what connectors have nothing to say about.
 */
